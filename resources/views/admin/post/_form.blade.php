            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <img src="{{ \App\Exceptions\Handler::page_image($page_image) }}" class="img img_responsive" id="page-image-preview" style="max-height:40px">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group row">
            <div class="col-md-8 col-md-offset-3">
                <div class="checkbox">
                    <label>
                        <input {{ \App\Exceptions\Handler::checked($is_draft) }} type="checkbox" name="is_draft">
                        草稿?
                    </label>
                </div>
            </div>
